...
import { ArrowLeft, Globe, Wrench, Settings, Plus, Trash2, Sparkles } from "lucide-react";
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" value={iban} onChange={(e) => setIban(e.target.value)}
                ...
                className="mt-1 w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" />
            </div>
            <div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-semibold">Lignes de la facture</h2>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
          ...
          {showAdvanced && (
            <div className="mt-4 space-y-4 border-t border-gray-100 pt-4">
              <div>
                <label className="text-sm font-medium text-gray-700">Préfixe de la facture</label>
                ...
                <p className="text-xs text-gray-400 mt-1">Le numéro sera généré automatiquement.</p>
              </div>
